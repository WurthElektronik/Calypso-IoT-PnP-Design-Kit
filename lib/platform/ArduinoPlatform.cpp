...
{
  float measuredvbat = analogRead(V_BAT_PIN);
...
/**
 * @brief  Initialize the SH1107 display
 * @retval none
 */
void SH1107_Init()
{
...
/**
 * @brief  Display string on the SH1107
 * @param fontSize
 * @param cursorX
 * @param cursorY
 * @param text
 * @retval none
 */
void SH1107_Display(uint8_t fontSize, uint8_t cursorX, uint8_t cursorY, const char *text)
{
  display.clearDisplay();
  display.display();
