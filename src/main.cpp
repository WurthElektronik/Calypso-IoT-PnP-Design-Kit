...
void setup()
{
    ...
    buttonInit(BUTTON_C_ID, BUTTON_C, OnBtnPress_C, NULL);
    buttonInit(BUTTON_B_ID, BUTTON_B, OnBtnPress_B, NULL);
...
void loop()
{
    ...
    case provisioning:
    {
        ...
        if (Device_provision())
        {
            //Restart device after provisioning
            Device_restart();
        }
        else
        {
